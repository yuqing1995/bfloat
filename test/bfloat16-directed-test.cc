...
void test_case_bfloat16_multiplication(){
    ...
    UTST_ASSERT_FLOAT_EQ(var3.binary2float(), (45.5 * 30.33), 5);
    UTST_ASSERT_FLOAT_EQ(var6.binary2float(), (124.5*-847.32) , 5);
    UTST_ASSERT_FLOAT_EQ(var9.binary2float(), (-33.5 * -12.32) , 5);
    UTST_ASSERT_FLOAT_EQ(var12.binary2float(), (43.5 * 98.2) , 5);
}
...
int main( int argc, char** argv )
{
  ...
  //if ( ( n == 0 ) || ( n == 4 ) ) test_case_4_bfloat16_creation_large_number();
  return 0;
}